...
int yylex(void)
{
  ...
  yytext[yyleng = 0] = '\0';
	...
	switch(c)
	{
		case ';': return POINT_VIRGULE; break;
		case '+': return PLUS; break;
		case '-': return MOINS; break;
		case '*': return FOIS; break;
		case '/': return DIVISE; break;
		case '(': return PARENTHESE_OUVRANTE; break;
		case ')': return PARENTHESE_FERMANTE; break;
		case '[': return CROCHET_OUVRANT; break;
		case ']': return CROCHET_FERMANT; break;
		case '{': return ACCOLADE_OUVRANTE; break;
		case '}': return ACCOLADE_FERMANTE; break;
		case '=': return EGAL; break;
		case '<': return INFERIEUR; break;
		case '&': return ET; break;
		case '|': return OU; break;
		case '!': return NON; break;
		case ',': return VIRGULE; break;
		default: break;
	}
	...
	if(is_alphanum(c)){
		...
		{
			if(strcmp(yytext,tableMotsClefs[i])==0) return codeMotClefs[i];
		}
		return ID_FCT;
	}
	return 0;
